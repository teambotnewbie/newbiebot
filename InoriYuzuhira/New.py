...
#-----------------------------------------------
				...
				if msg.from_ in admin:
					cl.sendText(msg.to,"Inori")
					ki.sendText(msg.to,"Miku")
                    kk.sendText(msg.to,"Hanami")
#-----------------------------------------------
            elif "Bot say " in msg.text:
					bctxt = msg.text.replace(" Kami disini","")
...
#-----------------------------------------------
                ...
                if msg.from_ in creator:
                    ...
                    kk.sendText(msg.to,"Jadi gausah sok")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ki.sendText(msg.to,"Jangan ngambek ya")
                                ki.sendText(msg.to,"Nanti aku ketawa")
                            except:
                                pass
              ...
              if msg.from_ in creator:
                if admin == []:
                    ...
                    cl.sendText(msg.to,"Dikit lagi jadi admin cie...")
                    mc = ""
                    for mi_d in admin:
                        mc += "=>" +cl.getContact(mi_d).displayName + "\n"
                    cl.sendText(msg.to,mc)
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                 if wait["Protectcancel"] == True:
                     if wait["lang"] == "JP":
                         cl.sendText(msg.to,"Jangan macam macam di grub ini!")
                         ki.sendText(msg.to,"Jgn cancel undangan")
                         kk.sendText(msg.to,"atau autokick!")
                     else:
                         cl.sendText(msg.to,"done")
              ...
              if msg.from_ in admin:
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Protect Csncel Off")
                    else:
                        cl.sendText(msg.to,"done")
                        ki.sendText(msg.to,"sudah")
                else:
            	...
            	if msg.toType == 2:
            	    if msg.from_ in admin:
                        ...
                        if targets == []:
                            ...
                            ki.sendText(msg.to,"Not")
                            ki.sendText(msg.to,"Found")
#-----------------------------------------------
				...
				if msg.from_ in admin:
					ki.sendText(msg.to,"Aku imut")
					kk.sendText(msg.to,"Aku Cantik")
					kc.sendText(msg.to,"Aku ganas")
            elif msg.text in ["#welcome"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"Selamat datang di Grup")
					kk.sendText(msg.to,"Patuhi Rules")
                    kk.sendText(msg.to,"Langgar? kick")
#-----------------------------------------------
            elif msg.text in ["PING","Ping","ping","Samlekom","samlekom"]:
				ki.sendText(msg.to,"kamu imut")
				kk.sendText(msg.to,"tapi ")
				kc.sendText(msg.to,"hatimu busuk")
#-----------------------------------------------
            elif msg.text in ["Responsename","Respon"]:
				if msg.from_ in admin:
					cl.sendText(msg.to,"Iori disini")
					ki.sendText(msg.to,"Miku disini")
                    kk.sendText(msg.to,"Hanami disini")
#-----------------------------------------------
            ...
            for zx in range(0,20):
                ...
                if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
                    try:    
                        ...
                        cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By line:://ti/p/~babydino20")
                        kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
                        kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Channel Youtube : YG ENTERTAIMENT")
                        print "DiLike"
                    except:
                            pass
                else:
